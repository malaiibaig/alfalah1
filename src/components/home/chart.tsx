              ...
              { constants.chart.cards.map((stat, index) => (
                ...
                >
                  <p className="text-2xl font-bold">
                    {stat.label === constants.chart.totalWorth
...
//     xAxis: {
//         categories: [
//             '6 Jul', '7 Jul', '8 Jul', '9 Jul', '10 Jul', '11 Jul', '12 Jul', '13 Jul', '14 Jul', '15 Jul', '16 Jul', '17 Jul', '18 Jul', '19 Jul'
//         ],
//         tickmarkPlacement: 'on',
//         gridLineWidth: 0,
//         lineColor: '#E9EBED',
...
//                 ]
//             },
//             data: [0, 0, 0, 0, 0, 0, 0, 1, 1, 2, 2, 3, 2, 2],
//             lineWidth: 2,
//             lineColor: '#E2C385',
//             fillOpacity: 0.15,
//             marker: { enabled: false },
...
//         },
//         {
//             type: 'areaspline', // Change to areaspline for smooth curves
//             name: 'Series 2',
//             color: '#B6D3C5',
//             fillColor: {
//                 linearGradient: {
...
// const stats = [
//     { label: constants.chart.totalTransactions, value: 0 },
//     { label: constants.chart.totalWorth, value: 0 },
//     { label: constants.chart.units, value: 0 },
//     { label: constants.chart.buildings, value: 0 },
//     { label: constants.chart.lands, value: 0 },
// ];

// export default function Chart() {
//     const [transactionType, setTransactionType] = useState(constants.chart.filter1);
//     const chartComponentRef = useRef<HighchartsReact.RefObject>(null);
//     const [range, setRange] = useState<DateRange>({
//         from: new Date(),
//         to: new Date(),
...
//     return (
//         <div className="w-full bg-bg-solitude pt-8 pb-24">
//             <div className="container mx-auto">
//                 <div className="w-[90%] mx-auto flex justify-between items-center">
//                     <div className="w-full bg-white rounded-xl p-6">
//                         <h1 className="text-2xl lg:text-4xl" dangerouslySetInnerHTML={{ __html: constants.chart.title }} />
//                         <div className="flex flex-col lg:flex-row w-full justify-between items-center mt-4">
//                             <div className="w-full lg:w-[26%] flex bg-[#E9EBED] rounded-full p-1 justify-between">
//                                 <Button
//                                     variant={transactionType === constants.chart.filter1 ? "white" : "ghost"}
//                                     size="sm"
//                                     className="rounded-full w-[30%]"
//                                     onClick={(e) => {
//                                         e.preventDefault();
...
//                                 </Button>
//                                 <Button
//                                     variant={transactionType === constants.chart.filter2 ? "white" : "ghost"}
//                                     size="sm"
//                                     className="rounded-full w-[30%]"
//                                     onClick={(e) => {
//                                         e.preventDefault();
...
//                                 </Button>
//                                 <Button
//                                     variant={transactionType === constants.chart.filter3 ? "white" : "ghost"}
//                                     size="sm"
//                                     className="rounded-full w-[30%]"
//                                     onClick={(e) => {
//                                         e.preventDefault();
//                                         setTransactionType(constants.chart.filter3);
//                                     }}
//                                 >
//                                     {constants.chart.filter3}
//                                 </Button>
//                             </div>
//                             <div className="w-full mt-2 lg:mt-0 lg:w-[74%] flex justify-end">
//                                 <DateRangePicker
...
//                                 <div key={index} className="w-[46%] lg:w-[20%] rounded-md bg-[#E9EBED] flex flex-col justify-between items-center p-4">
...
//                         <div className="flex justify-between items-center mt-6">
//                             <div className="w-full lg:w-[50%] rounded-md p-4">
//                                 <p className="text-lg">{constants.chart.range} <span className="font-bold">{range.from?.toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</span> - <span className="font-bold">{range.to?.toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}</span></p>
//                             </div>
//                         </div>
